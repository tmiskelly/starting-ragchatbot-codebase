...
"""
    ...
    def _execute_round(self, round_state: Dict[str, Any], tools: Optional[List], tool_manager) -> Any:
        ...
        try:
            ...
            return self._create_error_response(f"API error in round {round_state['round_number']}: {str(e)}")
