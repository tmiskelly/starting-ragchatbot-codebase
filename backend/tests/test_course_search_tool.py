...
class TestCourseSearchTool:
    ...
    def test_execute_with_both_filters(self, course_search_tool, mock_vector_store):
        ...
        result = course_search_tool.execute("specific content", course_name="Python", lesson_number=1)
    ...
    def test_execute_with_empty_results_and_filters(self, course_search_tool, mock_vector_store):
        ...
        result = course_search_tool.execute("test", course_name="Python", lesson_number=5)
        
        assert "No relevant content found in course 'Python' in lesson 5" in result
    
    def test_format_results_with_sources_tracking(self, course_search_tool, mock_vector_store):
    ...
    def test_format_results_without_lesson_numbers(self, course_search_tool, mock_vector_store):
...
class TestCourseSearchToolEdgeCases:
    ...
    def test_execute_with_special_characters(self, course_search_tool, mock_vector_store):
