...
class TestRAGSystemInitialization:
    ...
    def test_tool_registration(self, test_config):
        ...
        with patch('rag_system.DocumentProcessor'), \
            ...
            with patch('rag_system.CourseSearchTool', return_value=mock_search_tool), \
...
class TestRAGSystemQuery:
    ...
    def test_query_with_session(self, test_config):
        ...
        with patch('rag_system.DocumentProcessor'), \
            ...
            response, sources, source_links = rag_system.query("Follow-up question", session_id="test_session")
...
class TestRAGSystemDocumentProcessing:
    ...
    def test_add_course_document_success(self, test_config):
        ...
        with patch('rag_system.AIGenerator'), \
            ...
            mock_document_processor.process_course_document.assert_called_once_with("/path/to/course.pdf")
    ...
    def test_add_course_document_error(self, test_config):
        ...
        mock_document_processor = Mock()
        mock_document_processor.process_course_document.side_effect = Exception("Processing failed")
