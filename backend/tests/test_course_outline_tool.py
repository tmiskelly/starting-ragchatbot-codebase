...
class TestCourseOutlineTool:
    ...
    def test_execute_malformed_lessons_json(self, course_outline_tool, mock_vector_store):
    ...
    def test_execute_lessons_sorted_by_number(self, course_outline_tool, mock_vector_store):
        ...
        lines = result.split('\n')
        lesson_lines = [line for line in lines if line.strip() and any(char.isdigit() for char in line) and '.' in line]
    ...
    def test_execute_partial_course_name_match(self, course_outline_tool, mock_vector_store):
...
class TestCourseOutlineToolEdgeCases:
    ...
    def test_execute_with_empty_course_title(self, course_outline_tool, mock_vector_store):
    ...
    def test_execute_with_very_long_course_title(self, course_outline_tool, mock_vector_store):
    ...
    def test_execute_with_special_characters(self, course_outline_tool, mock_vector_store):
